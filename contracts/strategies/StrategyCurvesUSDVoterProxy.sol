...
contract StrategyCurvesUSDVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0xC25a3A3b969415c80451098fa907EC722572917F);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0xA5407eAE9Ba41422680e2e00537571bcC53efBfD);
    address public constant gauge = address(0xA90996896660DEcC6E997655E065b23788857849);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurvesUSDVoterProxy";
    }
    ...
    function harvest() public {
        ...
        if (_dai > 0) {
            ...
            ICurveFi(curve).add_liquidity([_dai, 0, 0, 0], 0);
        }
        uint256 _want = IERC20(want).balanceOf(address(this));
        if (_want > 0) {
