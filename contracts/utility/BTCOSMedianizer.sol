...
interface UniswapAnchoredView {
    function price(string calldata) external view returns (uint);
}
...
contract OSMedianizer {
    ...
    OracleSecurityModule constant public OSM = OracleSecurityModule(0xf185d0682d50819263941e5f4EacC763CC5C6C42);
    UniswapAnchoredView constant public MEDIANIZER = UniswapAnchoredView(0x9B8Eb8b3d6e2e0Db36F41455185FEF7049a35CaE);
